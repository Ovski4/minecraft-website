 ...
 * @ORM\Entity(repositoryClass="Ovski\StatsBundle\Repository\StatsRepository")
 */
class Stats
{
    /**
     * @ORM\OneToOne(targetEntity="Ovski\StatsBundle\Entity\Player")
     ...
     * Set player
     *
     * @param \Ovski\StatsBundle\Entity\Player $player
     * @return Stats
     */
    public function setPlayer(\Ovski\StatsBundle\Entity\Player $player)
    {
        $this->player = $player;
